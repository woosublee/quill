...
struct LocalAIServerProcessTests {
    static func main() throws {
        ...
        try testReservingTwicePicksDifferentPorts()
    ...
    private static func testReservingTwicePicksDifferentPorts() throws {
        let first = try reserveEphemeralLoopbackPort()
        let second = try reserveEphemeralLoopbackPort()
        assert(first != second)
    }
