...
struct SystemAudioAppStateRoutingTests {
    static func main() throws {
        ...
        precondition(source.contains("systemDefaultAndSystemAudioRecorder.stopRecording { url in"))
        ...
        precondition(source.contains("guard await ensureRecordingInputAccess(for: audioInputID) else {"))
